...
{
	public class triviaText : TextView
	{
		private const string Tag = "TextView";

		protected triviaText(IntPtr javaReference, JniHandleOwnership transfer) 
			: base(javaReference, transfer)
		{
		}

		public triviaText(Context context) 
			: this(context, null)
		{
		}

		public triviaText(Context context, IAttributeSet attrs) 
			: this(context, attrs, 0)
		{
		}

		public triviaText(Context context, IAttributeSet attrs, int defStyle) 
